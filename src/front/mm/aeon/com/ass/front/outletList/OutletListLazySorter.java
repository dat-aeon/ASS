...
public class OutletListLazySorter implements Comparator<OutletListLineBean> {
    ...
    public OutletListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(OutletListLineBean member1, OutletListLineBean member2) {
        applicationLogger.log("Outlet List Sorter Process started.", LogLevel.INFO);
        try {
            ...
            applicationLogger.log("Outlet List Sorter Process finished.", LogLevel.INFO);
