...
public class AgencyListLazySorter implements Comparator<AgencyListSearchLineBean> {
    ...
    public AgencyListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(AgencyListSearchLineBean member1, AgencyListSearchLineBean member2) {
        applicationLogger.log("Remaining List Sorter Process started.", LogLevel.INFO);
        try {
            ...
            applicationLogger.log("Remaining List Sorter Process finished.", LogLevel.INFO);
