...
public class RegisteredListLazySorter implements Comparator<RegisteredListLineBean> {
    ...
    public RegisteredListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(RegisteredListLineBean member1, RegisteredListLineBean member2) {
