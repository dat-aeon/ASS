...
public class AgencyUserLazySorter implements Comparator<AgencyUserLineBean> {
    ...
    public AgencyUserLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(AgencyUserLineBean member1, AgencyUserLineBean member2) {
