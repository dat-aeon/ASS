...
public class JudgementStatusListLazySorter implements Comparator<JudgementStatusListLineBean> {
    ...
    public JudgementStatusListLazySorter(String sortField, SortOrder sortOrder) {
        this.sortOrder = sortOrder;
        this.sortField = sortField;
    }

    public int compare(JudgementStatusListLineBean member1, JudgementStatusListLineBean member2) {
