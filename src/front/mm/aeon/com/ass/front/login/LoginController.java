...
import mm.aeon.com.ass.base.dto.managementUserInfoRefer.ManagementUserInfoReferReqDto;
import mm.aeon.com.ass.base.dto.managementUserInfoRefer.ManagementUserInfoReferResDto;
...
public class LoginController extends AbstractASSController
    ...
    public LoginFormBean process(LoginFormBean loginFormBean) {
        ...
        try {
            ManagementUserInfoReferReqDto manageInfoReferReq = new ManagementUserInfoReferReqDto();
            manageInfoReferReq.setLoginID(loginFormBean.getLoginInfo().getUserId());
            manageInfoReferReq.setPassword(PasswordEncoder.encode(loginFormBean.getLoginInfo().getPassword()));
            ManagementUserInfoReferResDto manageInfoReferRes =
                    (ManagementUserInfoReferResDto) CommonUtil.getDaoServiceInvoker().execute(manageInfoReferReq);

            if (manageInfoReferRes == null) {
                ...
                if (loginInfoReferRes != null && loginInfoReferRes.getOutletName().contains(ASSCommon.OUT_HEAD_OFFICE)) {

                    if (loginFormBean.getLoginUserInfo() == null) {
                        loginFormBean.setLoginUserInfo(new LoginUserInfo());
                    }

                    loginFormBean.getLoginUserInfo().setId(loginInfoReferRes.getId());
                    ...
                    loginFormBean.getLoginUserInfo().setUserTypeName(ASSCommon.TWO);
                ...
                loginFormBean.getLoginUserInfo().setId(manageInfoReferRes.getId());
                loginFormBean.getLoginUserInfo().setUserId(manageInfoReferRes.getLoginID());
                loginFormBean.getLoginUserInfo().setUserName(manageInfoReferRes.getName());
                loginFormBean.getLoginUserInfo().setUserTypeName(Integer.toString(manageInfoReferRes.getRole()));
                loginFormBean.getLoginUserInfo().setLoggedIn(true);
                MDC.put("UserID", loginFormBean.getLoginUserInfo().getUserId());
