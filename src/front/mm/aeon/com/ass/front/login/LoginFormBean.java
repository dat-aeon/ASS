...
public class LoginFormBean extends AbstractFormBean implements IRequest, IResponse {
    ...
    public String login() {
        ...
        } else if(loginUserInfo.getUserTypeName().equals(ASSCommon.TWO)) {
    ...
    public String notLoggedInMessage() {
        ...
        HttpServletRequest request =
                (HttpServletRequest) FacesContext.getCurrentInstance().getExternalContext().getRequest();
        Boolean sessionTimeOut = (Boolean) request.getSession().getAttribute(ASSCommon.SESSION_TIMEOUT_KEY);
